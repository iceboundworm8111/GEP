        ...
        , m_dirty(false)
    {
        ...
        while (!file.eof())
        {
            ...
            else if (tokens.at(0) == "f" && tokens.size() >= 4)
            {
                ...
                if (sub.size() >= 2 && tcs.size()) f.a.texcoord = tcs.at(atoi(sub.at(1).c_str()) - 1);
                ...
                for (size_t ti = 2; ti + 1 < tokens.size(); ti++)
                {
                    ...
                    if (sub.size() >= 2 && tcs.size()) f.b.texcoord = tcs.at(atoi(sub.at(1).c_str()) - 1);
                    ...
                    if (sub.size() >= 2 && tcs.size()) f.c.texcoord = tcs.at(atoi(sub.at(1).c_str()) - 1);
